...
RESTORE_SCRIPT = backuprestore/ukwinika_automated_restore.sh
...
install: deps
	...
	@echo "✅ Restore script installed to $(INSTALL_DIR)/ukwinika_automated_restore.sh"
...
uninstall:
	...
	@sudo rm -f $(INSTALL_DIR)/ukwinika_automated_restore.sh
...
clean:
	...
	@echo "✅ Logs cleaned"
	@sudo $(INSTALL_DIR)/ukwinika_automated_restore.sh clean 2>/dev/null || true
